  ...
  Highcharts.chart('monitoring_graphycs_div', {
    ...
    tooltip: {
      ...
      formatter: function formatter() {
        var pointDate = new Date(this.x).toLocaleDateString('it-IT');
        pointDate+= ' '+ new Date(this.x).toLocaleTimeString('it-IT');
        var outputHtml = "<small>".concat(pointDate, "</small><br/>");

        if (this.points[0]) {
          outputHtml += "<small><i class=\"fas fa-thermometer-half\" style=\"color:" + Highcharts.getOptions().colors[0] + "\"></i> " + sensorData.language_resource.temperature + " ".concat(this.points[0].y, "\xB0C</small><br/>");
        }

        if (this.points[1]) {
          outputHtml += "<small><i class=\"fas fa-tint\" style=\"color:" + Highcharts.getOptions().colors[1] + "\"></i> " + sensorData.language_resource.humidity + " ".concat(this.points[1].y, "%</small>");
        }
...
/***/ 2:
/*!******************************************!*\
  !*** multi ./resources/js/monitoring.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp\htdocs\tempohub\resources\js\monitoring.js */"./resources/js/monitoring.js");

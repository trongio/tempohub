        ...
        if (data.success == 'ok') {
          ...
          if(reporttype == 'temperature') {
            ...
            $.each(data.data_array, function (key, val) {
              ...
              table_range.row.add( [
                val.min_tempo,
                Math.round((val.avg_tempo +  Number.EPSILON) * 100) / 100,
                val.max_tempo,
                val.rangetime1readable,
                val.rangetime2readable,
                val.rangetime3readable,
                val.rangetime4readable,
                val.rangetime5readable,
                val.fulltime,
                val.range1,
                val.range2,
                val.range3,
                ...
                val.range5,
                val.full_count,
                Math.round((val.range1percent +  Number.EPSILON) * 100) / 100 + '%',
                Math.round((val.range2percent +  Number.EPSILON) * 100) / 100 + '%',
                Math.round((val.range3percent +  Number.EPSILON) * 100) / 100 + '%',
                Math.round((val.range4percent +  Number.EPSILON) * 100) / 100 + '%',
                Math.round((val.range5percent +  Number.EPSILON) * 100) / 100 + '%',
                Math.round((val.fullpercent +  Number.EPSILON) * 100) / 100 + '%',
              ] ).draw( false );
            }); 
          }
